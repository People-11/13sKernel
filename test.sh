...
cd ~/ && git clone https://github.com/People-11/13sKernel.git --depth=1
...
patch -p0 -l < 30_workqueue_Queue_everything.patch
patch -p0 -l < 30_workqueue_Queue_everything1.patch
...
# patch -p0 -l < 33_sched_fair01.patch
# patch -p0 -l < 33_sched_fair02.patch
# patch -p0 -l < 33_sched_fair03.patch
# patch -p0 -l < 33_sched_fair04.patch
# patch -p0 -l < 33_sched_fair05.patch
# patch -p0 -l < 33_sched_fair06.patch
# patch -p0 -l < 33_sched_fair07.patch
# patch -p0 -l < 33_sched_fair08.patch
# patch -p0 -l < 34_sched_fair_Set_asym_priority.patch
...
patch -p0 -l < 40_sched_Disable_TTWU_QUEUE.patch
patch -p0 -l < 41_sched_Use_SCHED_RR.patch
...
patch -p0 -l < 63_ipv4_tcp_NODELAY.patch
...
patch -p0 -l < 83_arm64_kprobes_1.patch
patch -p0 -l < 83_arm64_kprobes_2.patch
...
# patch -p0 -l < 81_UKSM_0.patch
# patch -p0 -l < 81_UKSM_1.patch
# patch -p0 -l < 81_UKSM_2.patch
# patch -p0 -l < 81_UKSM_3.patch
# patch -p0 -l < 81_UKSM_4.patch
# patch -p0 -l < 81_UKSM_5.patch
# patch -p0 -l < 81_UKSM_6.patch
# patch -p0 -l < 81_UKSM_7.patch
# patch -p0 -l < 81_UKSM_8.patch
# echo 'CONFIG_UKSM_CPU_GOVERNOR=4' >> ./common/arch/arm64/configs/gki_defconfig && echo 'CONFIG_UKSM_SLEEP_MS=60000' >> ./common/arch/arm64/configs/gki_defconfig